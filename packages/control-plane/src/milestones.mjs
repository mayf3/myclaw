export function buildMilestonesPayload() {
  return {
    ...
    currentMilestone: "M4",
    summary:
      "Phase 1.9 links Feishu LLM replies to ask_* runs so group-message effects are human-testable.",
    milestones: [
      ...
      m("M4", "Agent Runtime 与审批", "partial", 60, "已有 migration approval queue、smoke tool approval execution、OpenAI Responses ask smoke、agent config proposal approval 和 Feishu LLM reply chain，缺通用 tool schema/policy、sandbox 和 LLM tool loop"),
