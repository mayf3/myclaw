export function buildMilestonesPayload() {
  return {
    ...
    currentMilestone: "M4",
    summary:
      "Phase 1.7 adds real LLM reply smoke before enabling model-driven tool execution.",
    milestones: [
      ...
      m("M4", "Agent Runtime 与审批", "partial", 48, "已有 migration approval queue、smoke tool approval execution 和 OpenAI Responses ask smoke，缺通用 tool schema/policy、sandbox 和 LLM tool loop"),
