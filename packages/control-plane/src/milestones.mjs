export function buildMilestonesPayload() {
  return {
    ...
    currentMilestone: "M4",
    summary:
      "Phase 1.8 adds review-only agent configuration proposals before model-driven tool execution.",
    milestones: [
      ...
      m("M4", "Agent Runtime 与审批", "partial", 56, "已有 migration approval queue、smoke tool approval execution、OpenAI Responses ask smoke 和 agent config proposal approval，缺通用 tool schema/policy、sandbox 和 LLM tool loop"),
