export function buildMilestonesPayload() {
  return {
    ...
    currentMilestone: "M4",
    summary:
      "Phase 1.6 adds a safe approval-to-tool smoke path before real agent tool execution.",
    milestones: [
      ...
      m("M4", "Agent Runtime 与审批", "partial", 38, "已有 migration approval queue 和 smoke tool approval execution，缺通用 tool schema/policy、sandbox 和 LLM loop"),
