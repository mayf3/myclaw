const moduleDefinitions = [
  {
    ...
    hermes: 78,
    openhuman: 86,
    gap: "已拆 routes/auth 并提供 run detail route，仍缺 WS/event stream、scoped token、route schema",
  ...
  },
  {
    ...
    criteria: [
      ...
      c("migration-stage", "reviewable stage snapshot with checksum and summary", "partial", 65, "packages/migrate/src/stage.mjs"),
      c("migration-apply", "field diff, apply, rollback UI", "missing", 25, "docs/modules/openclaw-migration.md"),
    ],
  },
  {
    id: "agent-runtime",
