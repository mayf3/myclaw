const moduleDefinitions = [
  ...
  },
  {
    ...
    hermes: 92,
    openhuman: 90,
    gap: "已有 approval-to-tool smoke、OpenAI Responses 单轮 ask 和 review-only agent config proposal，但还没有 LLM tool loop、subagent、context budget",
    ...
    criteria: [
      ...
      c("agent-tool-loop", "LLM tool loop with ToolDescriptor dispatch", "missing", 0, "Phase 1.8 backlog"),
