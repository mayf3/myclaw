export function buildHumanExperimentsPayload() {
  const experiments = [
    ...
    experiment({
      ...
      successSignals: ["Human Experiments 区块可见", "当前 Phase 显示 1.2.1", "每个实验都有命令和成功信号"],
    ...
    experiment({
      ...
      successSignals: [
        ...
        "Dashboard Feishu adapter 显示 app credentials ready、websocket runtime missing、app-token outbound missing",
  ...
  return {
    ...
    layerRoadmap: [
      layer("L0", "接入层", "人与外部系统的消息进入、发出和归一化。", "partial", ["E0", "E2", "E2A", "E3"]),
      layer("L1", "Gateway", "统一 HTTP 控制面、鉴权、状态查询、事件进入。", "partial", ["E1", "E2A", "E3", "E5"]),
    ...
    planningMap: [
      ...
      step("M2", "Feishu/Lark 边界", "E2A/E2/E3", "credential presence 现在可测，webhook 配置后可测"),
