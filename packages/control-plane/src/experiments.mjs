export function buildHumanExperimentsPayload() {
  const experiments = [
    ...
    experiment({
      ...
      successSignals: ["Human Experiments 区块可见", "当前 Phase 显示 1.4", "每个实验都有命令和成功信号"],
  ...
  return {
    ...
    layerRoadmap: [
      ...
      layer("L1", "Gateway", "统一 HTTP 控制面、鉴权、状态查询、事件进入和 mutation audit。", "partial", ["E1", "E1B", "E2A", "E2B", "E2C", "E3", "E5"]),
    ...
    planningMap: [
      ...
      step("M1", "Gateway 与 Dashboard", "E1/E1B", "立即可测"),
