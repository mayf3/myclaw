export function buildHumanExperimentsPayload() {
  ...
  return {
    ...
    layerRoadmap: [
      layer("L0", "接入层", "人与外部系统的消息进入、发出和归一化。", "partial", ["E0", "E2", "E2A", "E2B", "E3"]),
      layer("L1", "Gateway", "统一 HTTP 控制面、鉴权、状态查询、事件进入。", "partial", ["E1", "E2A", "E2B", "E3", "E5"]),
    ...
    planningMap: [
      ...
      step("M2", "Feishu/Lark 边界", "E2A/E2B/E2/E3", "WebSocket 群回复现在可测，webhook 配置后可测"),
